...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--checkpoint_steps', type=int, default=376, help='Checkpoint saving frequency')
        ...
        train.add_argument('--run_smplify', default=True, action='store_true', help='Run SMPLify during training') 
